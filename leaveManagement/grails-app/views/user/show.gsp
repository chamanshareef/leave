	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.validTill}">
				<li class="fieldcontain">
					<span id="validTill-label" class="property-label"><g:message code="user.validTill.label" default="Valid Till" /></span>
					
						<span class="property-value" aria-labelledby="validTill-label"><g:formatDate date="${userInstance?.validTill}" /></span>

<%@page import="leavemanagement.LeaveAppliedService"%>
...
<g:form controller="leaveApplied" action="reapply" style="padding-left:100px;">
<div style="width: 100%;">
<label>Start Date:</label><g:datePicker name="start_date" value="${leave.startDate}" precision="day" years="${2012..2100}"/>
...
<br /><br />
<label>End Date:</label><g:datePicker name="end_date" value="${leave.endDate}" precision="day" years="${2012..2100}"/>
<label> Half Day: </label>
...
<label>&nbsp;</label><input type="submit" value="Reapply"><br />
</div>
</g:form>
